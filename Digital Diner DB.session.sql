...
-- Sample user (password is 'password123' - would be hashed in production)
INSERT INTO users (username, password, role)
VALUES 
('admin', '$2a$10$XO5d0.5kELpQQmHFc.7hbuqfGT6FX6YjTazbMbxFYHpKMKpkGTHzy', 'admin'),
('staff', '$2a$10$XO5d0.5kELpQQmHFc.7hbuqfGT6FX6YjTazbMbxFYHpKMKpkGTHzy', 'staff'),
('customer', '$2a$10$XO5d0.5kELpQQmHFc.7hbuqfGT6FX6YjTazbMbxFYHpKMKpkGTHzy', 'customer');

-- Sample order
INSERT INTO orders (customer_id, total_amount, status, pickup_time)
VALUES (1, 0.00, 'pending', NOW() + INTERVAL '30 minutes');